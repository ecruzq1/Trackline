        ...
        <fieldset class="form-group">
          ...
          <table>
            ...
            <tr>
              ...
              <td><input type="password" class="form-control" id="PassUser" name="PassUser" value=""></td>
            </tr>
            <tr>
              <td><label for="RepassUser">Repita Contraseña: </label></td>
              <td><input type="password" class="form-control" id="RepassUser" name="RepassUser" value=""></td>
            </tr>
          </table>
        </fieldset>
      </div>
    </div>
    <input id="btnEditUser" type="button" class="btn btn-info" name="btnEditUser" value="Guardar Cambios">
    <input id="btnCancel" type="button" class="btn btn-info" name="btnCancel" value="Cancelar">
  </body>
</html>
